...
exports.addNewField = async (data) => {
  //Todo: Override strict schema
  // as of now new fields can only be added if first added on schema itself.
...
exports.removeField = async (fieldName) => {
